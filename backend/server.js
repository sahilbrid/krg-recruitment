...
app.use(cors({
    ...
    origin: 'http://krg-recruitment.s3-website.ap-south-1.amazonaws.com', // Whitelist the origin of your frontend application
  }));
...
const db = mysql.createConnection({
    host: 'nodedatabase.c5km66seixvz.ap-south-1.rds.amazonaws.com',
    user: 'admin',
    password: 'testing123',
    database: 'krg'
})
